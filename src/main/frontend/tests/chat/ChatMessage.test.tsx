...
describe('ChatMessage', () => {
  ...
  it('renders as a placeholder', async () => {
    render(<ChatMessage message={{ role: 'user', content: 'Hello' }} waiting />);

    expect(screen.getByLabelText('Message content').parentElement?.classList).toContain('waiting-message');
  });
